...
import { loadCookieData, triggerLogin, refreshCsrfToken, resolveBaseUrl, isLoginExpired, isCsrfTokenExpired } from '../core/utils';
import { t } from '../core/i18n';

function parseArgs(): { appType: string; formUuid: string; isRenderNav: string; title: string } {
...
function buildPostData(csrfToken: string, formUuid: string, isRenderNav: string, title: string): string {
...
function sendPostRequest(baseUrl: string, cookies: any[], requestPath: string, postData: string): Promise<any> {

          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
            ...
            <div style={{ background: 'linear-gradient(135deg, rgba(13,33,55,0.9), rgba(10,22,40,0.95))', border: '1px solid rgba(105,240,174,0.25)', borderRadius: '10px', padding: '14px', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '10px' }}>
              ...
              <a
                ...
                style={{ background: 'linear-gradient(135deg, #00B853, #00E5FF)', border: 'none', borderRadius: '22px', padding: '9px 24px', color: '#fff', fontSize: '12px', fontWeight: '700', cursor: 'pointer', letterSpacing: '1px', boxShadow: '0 4px 16px rgba(0,229,255,0.35)', textDecoration: 'none', display: 'inline-block' }}
              >
                {'\u7acb\u5373\u53c2\u4e0e\u53cd\u9988'}
              </a>

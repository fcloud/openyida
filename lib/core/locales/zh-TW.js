/**
 * zh-TW.js - Traditional Chinese (繁體中文) translations
 */
"use strict";
...
📊 重新整理彙總`,
  ...
  // ── lib/process/configure-process.js ───────────────
  configure_process: {
    usage: '用法: openyida configure-process <appType> <formUuid> <processDefinitionFile> [processCode]',
    title: '流程配置',
    app_id: '应用 ID',
    form_uuid: '表单 UUID',
    definition_file: '流程定义文件',
    from_cli: '来自命令行参数',
    file_not_found: '流程定义文件不存在',
    parse_failed: '解析流程定义失败',
    invalid_format: '流程定义格式不正确，需要包含 nodes 数组',
    definition_loaded: '流程定义已加载',
    nodes: '个节点',
    loading_auth: '加载登录态',
    auth_loaded: '登录态已加载',
    getting_process_code: '获取流程编码',
    switching_form_type: '切换表单类型为流程表单',
    switch_success: '表单类型切换成功',
  },

  // ── lib/process/create-process.js ──────────────────
  create_process: {
    usage: '用法: openyida create-process <appType> <formTitle> <fieldsJsonFile> <processDefinitionFile>',
    usage2: '用法: openyida create-process <appType> --formUuid <formUuid> <processDefinitionFile>',
    title: '流程表单创建',
    app_id: '应用 ID',
    mode: '模式',
    reuse_form: '复用现有表单',

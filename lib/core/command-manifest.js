...
const COMMAND_GROUPS = [
  ...
  },
  {
    ...
    commands: [
      ...
      command('create-page', ['create-page'], 'create-page <appType> "<name>" [--open|--no-open]', 'help.cmd_create_page'),
      ...
      command('publish', ['publish'], 'publish <src> <appType> <formUuid> [--open|--no-open]', 'help.cmd_publish'),

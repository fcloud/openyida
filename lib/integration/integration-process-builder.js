...
exports.mapEventTypes = mapEventTypes;
exports.buildDataRetrieveCondition = buildDataRetrieveCondition;
exports.buildDataCreateAssignments = buildDataCreateAssignments;
exports.buildProcessJson = buildProcessJson;
...
function buildDataRetrieveCondition(dataConditions) {
    const groupId = (0, integration_node_ids_1.generateRuleGroupId)();
    const rules = dataConditions.map(({ bFieldId, bFieldName, aFieldId, componentType }) => ({
        ...
        ruleId: (0, integration_node_ids_1.generateRuleItemId)(),
        parentId: groupId,
        extValue: 'processVar',
        ruleValue: aFieldId,
        name: bFieldName,
...
function buildProcessJson(options) {
    const { processCode, formUuid, appType, formEventTypes, notificationTitle, notificationContent, toUsers, nodeIds, addDataFormUuid, addDataAssignments, dataFormUuid, dataConditions, hasMessageNode, } = options;
    ...
    if (hasDataNode && dataNodeId) {
        const conditions = dataConditions && dataConditions.length > 0
            ...
            : { condition: 'AND', rules: [], ruleId: (0, integration_node_ids_1.generateRuleGroupId)(), conditionCode: '&&' };
                    ...
                    rules: [
                        {
                            ...
                            name: '',
                            required: false,
                            ruleId: (0, integration_node_ids_1.generateDataRuleId)(),
                            value: '',
                            valueType: 'literal',
                        },
                    ],
                    ...
                    buttons: [
                        {
                            ...
                            buttonUuid: (0, integration_node_ids_1.generateButtonUuid)(),
                        },
                    ],
                },
                appType,
...
//# sourceMappingURL=integration-process-builder.js.map
...
exports.generateButtonUuid = generateButtonUuid;
exports.generateProcessCode = generateProcessCode;
exports.generateRuleItemId = generateRuleItemId;
exports.generateRuleGroupId = generateRuleGroupId;
exports.generateDataRuleId = generateDataRuleId;
...
function generateNodeId() {
    const randomPart = crypto_1.default.randomBytes(6).toString('hex').slice(0, 11);
...
function generateButtonUuid() {
    return `button-${crypto_1.default.randomBytes(10).toString('hex').toUpperCase().slice(0, 20)}`;
}
/**
...
function generateRuleItemId() {
    const hex = () => crypto_1.default.randomBytes(2).toString('hex');
    const hex4 = () => crypto_1.default.randomBytes(4).toString('hex');
...
//# sourceMappingURL=integration-node-ids.js.map
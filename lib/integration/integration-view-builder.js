...
exports.buildAddDataChildList = buildAddDataChildList;
exports.buildViewJson = buildViewJson;
...
function buildViewJson(options) {
    const { formUuid, formEventTypes, notificationTitle, notificationContent, toUsers, appType, nodeIds, addDataFormUuid, addDataAssignments, addDataFormSchema, addDataFormName, dataFormUuid, dataConditions, hasMessageNode, } = options;
    ...
    if (hasDataNode && dataNodeId) {
        const conditions = dataConditions && dataConditions.length > 0
            ? (0, integration_process_builder_1.buildDataRetrieveCondition)(dataConditions)
...
//# sourceMappingURL=integration-view-builder.js.map
...
exports.BASE_COMPONENTS = exports.CHART_COMPONENT_MAP = void 0;
exports.randomId = randomId;
exports.genNodeId = genNodeId;
exports.genFieldAlias = genFieldAlias;
exports.genFieldId = genFieldId;
exports.inferDataType = inferDataType;
exports.deriveFilterFieldCode = deriveFilterFieldCode;
...
exports.CHART_COMPONENT_MAP = CHART_COMPONENT_MAP;
// ── ID 生成工具 ───────────────────────────────────────
/**
 * 生成随机 8 位字母数字 ID（小写）
 */
...
exports.BASE_COMPONENTS = BASE_COMPONENTS;
// ── 字段类型推断 ──────────────────────────────────────
/**
 * 根据字段类型推断正确的 dataType。
 *
 * @param fieldType - 字段类型，如 SelectField、EmployeeField 等
 * @param explicitDataType - 显式指定的 dataType，如果提供则优先使用
 * @returns 推断出的 dataType
 */
 ...
 *
 * @param fieldId - 字段 ID，如 selectField_xxx
 * @param fieldType - 可选的字段类型
 * @returns 实际使用的 fieldCode
 */

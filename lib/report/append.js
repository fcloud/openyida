...
function buildChartNode(chart, cubeTenantId) {
    ...
    const fieldId = (0, constants_2.genFieldId)(componentName);
    const nodeId = (0, constants_2.genNodeId)();
    const chartTitle = chart.title || (componentName + '_' + (0, constants_2.randomId)().slice(0, 4));

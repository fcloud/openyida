    ...
    if (filters.length > 0) {
        ...
        if (pageHeaderContent) {
            ...
            const builtFilters = filters.map((filterDef) => {
                const filterNodeId = (0, constants_2.genNodeId)();
                const filterFieldId = (0, constants_2.genFieldId)('YoushuSelectFilter');
            ...
            const containerFieldId = (0, constants_2.genFieldId)('filter');

 ...
 * - 日期字段：dateField_xxxxx（保存/更新值必须是 13 位毫秒时间戳）
 ...
 * 
 * 示例：
 * openyida data create form APP_XXX FORM-XXX --data-json '{"textField_xxx":"测试值"}'
 */
...
| 单选 | 字符串 | "选项一" |
| 多选 | 数组 | ["选项一", "选项二"] |
| 日期 | 13 位毫秒时间戳 | 1719705600000 |
| 日期区间 | 毫秒时间戳数组 | [1719705600000, 1722384000000] |
| 成员 | 数组 | ["userId"] |
| 部门 | 数组 | ["deptId"] |
| 图片 | 数组 | ["url1", "url2"] |
...
/*
# 插入需求管理数据
openyida data create form APP_PZS775X8ZG1BDDHD0J8Z FORM-91F6B7D25F114C78A0E66EB3CA01A328Q1D9 --data-json '{
  ...
  "dateField_vgya7xjkf": 1719705600000,

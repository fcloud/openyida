 ...
 * query-data.js 测试
 *
 * query-data.js 的内部纯函数（parseCliOptions, clampPageSize, snakeToCamel 等）
...
const SOURCE_PATH = path.join(__dirname, '..', 'lib', 'core', 'query-data.js');
...
describe('query-data.js structure', () => {
  test('导出 run 函数', () => {
    // TypeScript 编译后使用 exports.run = run 或 module.exports 形式
    const hasExport = sourceCode.includes('module.exports') || sourceCode.includes('exports.run');
